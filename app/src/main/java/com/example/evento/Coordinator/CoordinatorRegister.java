...
public class CoordinatorRegister extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_coordinator);
        ButterKnife.bind((Activity) this);
        this.logintxt.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                CoordinatorRegister.this.startActivity(new Intent(CoordinatorRegister.this, CoordinatorLogin.class));
            }
        });
